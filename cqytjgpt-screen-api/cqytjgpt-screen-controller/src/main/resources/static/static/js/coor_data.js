...
var placeList = [
    {name:'渝中区', geoCoord:[106.56288, 29.556742]},
    {name:'大渡口区', geoCoord:[106.48613, 29.481002]},
    {name:'江北区', geoCoord:[106.532844, 29.575352]},
    {name:'沙坪坝区', geoCoord:[106.4542, 29.541224]},
    {name:'涪陵区', geoCoord:[107.394905, 29.703652]},
    {name:'万州区', geoCoord:[108.380246, 30.807807]},
    {name:'南岸区', geoCoord:[106.560813, 29.523992]},
    {name:'九龙坡区', geoCoord:[106.480989, 29.523492]},
    {name:'大足区', geoCoord:[105.715319, 29.700498]},
    {name:'渝北区', geoCoord:[106.512851, 29.601451]},
    {name:'綦江区', geoCoord:[106.651417, 29.028091]},
    {name:'江津区', geoCoord:[106.253156, 29.283387]},
    {name:'长寿区', geoCoord:[107.074854, 29.833671]},
    {name:'北碚区', geoCoord:[106.437868, 29.82543]},
    {name:'合川区', geoCoord:[106.265554, 29.990993]},
    {name:'永川区', geoCoord:[105.894714, 29.348748]},
    {name:'璧山区', geoCoord:[106.231126, 29.593581]},
    {name:'黔江区', geoCoord:[108.782577, 29.527548]},
    {name:'巴南区', geoCoord:[106.519423, 29.381919]},
    {name:'南川区', geoCoord:[107.098153, 29.156646]},
    {name:'开州区', geoCoord:[108.413317, 31.167735]},
    {name:'荣昌区', geoCoord:[105.594061, 29.403627]},
    {name:'铜梁区', geoCoord:[106.054948, 29.839944]},
    {name:'潼南区', geoCoord:[105.841818, 30.189554]},
    {name:'城口县', geoCoord:[108.6649, 31.946293]},
    {name:'丰都县', geoCoord:[107.73248, 29.866424]},
    {name:'垫江县', geoCoord:[107.348692, 30.330012]},
    {name:'武隆县', geoCoord:[107.75655, 29.32376]},
    {name:'云阳县', geoCoord:[108.697698, 30.930529]},
    {name:'奉节县', geoCoord:[109.465774, 31.019967]},
    {name:'忠县', geoCoord:[108.037518, 30.291537]},
    {name:'梁平区', geoCoord:[107.800034, 30.672168]},
    {name:'巫溪县', geoCoord:[109.628912, 31.3966]},
    {name:'石柱土家族自治县', geoCoord:[108.112448, 29.99853]},
    {name:'巫山县', geoCoord:[109.878928, 31.074843]},
    {name:'酉阳土家族苗族自治县', geoCoord:[108.767201, 28.839828]},
    {name:'秀山土家族苗族自治县', geoCoord:[108.996043, 28.444772]},
    {name:'彭水苗族土家族自治县', geoCoord:[108.166551, 29.293856]}
]
