...
public class VehicleContrller implements Serializable{
	...
	public String qryVehicleList (PageRequest page, Vehicle vehicle) {
		...
		try {
			...
			String entId = ""; 
			Page<Vehicle> pager = vehicleService.qryVehicleList(page, vehicle, entId);
	...
	@ResponseBody
	public String saveVehicle (String vehiNo, String vehiType) {
		Map<String, Object> map = new HashMap<String, Object>();
		try {
			Map<String, Object> maps = vehicleService.saveVehicle(vehiNo, vehiType);
	...
	@ResponseBody
	public String modifVehicle (String vehiNo, String vehiType) {
		Map<String, Object> map = new HashMap<String, Object>();
		// 拆分车牌号
