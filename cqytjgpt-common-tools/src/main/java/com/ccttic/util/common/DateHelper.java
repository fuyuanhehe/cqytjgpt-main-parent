 ...
 * 
 ...
 @version  1.0.0
 @author  xgYin
 @see  com.studio.framework.common.helper.DateHelper.java
 @date  2016年12月3日
 */
public class DateHelper {
	...
	public static List<String> getWeeksByTimePeriod(String startDate, String endDate, String format) {
		...
		Date start = DateHelper.stringToDate(startDate,
				ObjectHelper.isEmpty(format) ? DateHelper.DATE_SHORT_FORMAT : format);
		Date end = DateHelper.stringToDate(endDate,
				ObjectHelper.isEmpty(format) ? DateHelper.DATE_SHORT_FORMAT : format);
	...
	public static void main(String[] args) {
		System.out.println(DateHelper.isBetween(DateHelper.getBeforeDay(getCurrentDate()),
				DateHelper.getAfterDay(getCurrentDate()), getCurrentDate()));
	}
}
