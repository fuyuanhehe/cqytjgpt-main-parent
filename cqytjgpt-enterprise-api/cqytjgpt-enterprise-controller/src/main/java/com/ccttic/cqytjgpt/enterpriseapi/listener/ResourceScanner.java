package com.ccttic.cqytjgpt.enterpriseapi.listener;
...
import com.ccttic.cqytjgpt.enterpriseapi.interfaces.menu.ResourceScannerService;
	...
	private void doScan(String[] beanNames, ApplicationContext context) {
		...
		for (String beanName : beanNames) {
			...
			if (clazzControllerAnno == null) {
				...
				String[] controllerRequestUri = clazzRequestMappingAnno == null ? null
						: clazzRequestMappingAnno.value();
				// 遍历当前控制器类的所有方法
