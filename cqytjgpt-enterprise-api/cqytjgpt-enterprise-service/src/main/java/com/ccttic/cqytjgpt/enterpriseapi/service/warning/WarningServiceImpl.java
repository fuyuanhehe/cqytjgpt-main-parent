package com.ccttic.cqytjgpt.enterpriseapi.service.warning;
...
import com.ccttic.cqytjgpt.enterpriseapi.interfaces.organization.IOrganizationService;
import com.ccttic.cqytjgpt.enterpriseapi.interfaces.warning.IWarningService;
import com.ccttic.cqytjgpt.enterpriseapi.mapper.danger.DrDangerMapper;
...
public class WarningServiceImpl implements IWarningService {
	...
	public Page<DrDangerVo> qryDriverList(Pageable page, DrDangerVo vo, EmployeePermission employeePermission) throws AppException {
		...
		//records.stream().filter(s->1==s.getFullstudystate()).forEach(s->s.setDangerdesc("满分学习"),s.setOverdueexaminestate(null),s.setOverdueproofstate(null));
