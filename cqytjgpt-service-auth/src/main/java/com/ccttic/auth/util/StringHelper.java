...
public class StringHelper {
	 ...
	 */
	public static String decodeFromUtfToCode(String source) throws UnsupportedEncodingException {
	 ...
	 * @throws UnsupportedEncodingException
	 */
	public static String decodeFromUtfToCode(String source, String code) throws UnsupportedEncodingException {
	 ...
	 * @throws UnsupportedEncodingException
	 */
	public static String decodeFromISOToCode(String source, String code) throws UnsupportedEncodingException {
		if (ObjectHelper.isEmpty(source))
			return null;
	 ...
	 * @throws UnsupportedEncodingException
	 */
	public static String decodeFromISOToCode(String source) throws UnsupportedEncodingException {
		...
		for (Field field : obj.getClass().getDeclaredFields()) {
			...
			if (!ObjectHelper.isEmpty(fieldObj)) {
				...
				if (field.getType() == String.class) {
					...
					field.set(obj,
							!fieldObj.toString().trim().isEmpty() ? decodeFromISOToCode(fieldObj.toString()) : null);
				}
			}
		}
	}
	 ...
	 * @return
	 */
	public static String stringArrayToDelimitedStringWithQuotation(String[] strAry) {
		...
		return StringUtils.arrayToCommaDelimitedString(StringUtils.toStringArray(strList));
	}
	 ...
	 * @return
	 */
	public static String stringArrayToDelimitedString(String[] strAry, String delimtor) {
